  ...
  en: {
    ...
    footer: {
      quips: [
        ...
        'Zero dependencies. Including confidence.',
        'Not A/B tested. You just got the only version.',
  ...
  es: {
    ...
    footer: {
      quips: [
        ...
        'Cero dependencias. Tampoco de la confianza.',
        'Sin A/B test. Solo hay una versión, y es esta.',
